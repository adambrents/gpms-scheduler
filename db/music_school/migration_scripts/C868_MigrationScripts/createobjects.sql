...
DROP TABLE IF EXISTS teacher_student_instrument;
...
CREATE TABLE IF NOT EXISTS `teacher_student_instrument` (
  ...
  CONSTRAINT `fk_student_id_teacherinstrument` FOREIGN KEY (`Student_Id`) REFERENCES `students` (`Student_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
